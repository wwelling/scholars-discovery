...
public class Person extends Common {
    ...
    @FieldType(type = "whole_string")
    @FieldSource(
        template = "person/orcidId",
        predicate = "http://vivoweb.org/ontology/core#orcidId",
        parse = true
    )
    ...
    @FieldType(type = "nested_whole_strings", copyTo = { "positionOrganization_facets" })
    @NestedObject(
        root = false,
        properties = {
            @Reference(value = "positionOrganizationParent", key = "parent")
        }
    )
    @FieldSource(
        template = "person/positionOrganization",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label",
        unique = true
    )
    ...
    @FieldSource(
        template = "person/positionOrganizationParent",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @FieldSource(
        template = "person/overview",
        predicate = "http://vivoweb.org/ontology/core#overview"
    )
    private String overview;

    @NestedObject
    @FieldType(type = "nested_tokenized_strings", copyTo = { "_text_", "researchAreas_facets" })
    @FieldSource(
        template = "person/researchArea",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @FieldSource(
        template = "person/clinicalActivity",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @NestedObject(properties = {
        ...
        @Reference(value = "educationAndTrainingIsDateSuppressed", key = "isDateSuppressed")
    })
    @FieldSource(
        template = "person/educationAndTraining",
        predicate = "http://vitro.mannlib.cornell.edu/ns/vitro/0.7#mostSpecificType",
        parse = true
    )
    ...
    @NestedObject(properties = {
        @Reference(value = "selectedPublicationType", key = "type"),
        @Reference(value = "selectedPublicationDate", key = "publicationDate"),
        @Reference(value = "selectedPublicationPublisher", key = "publisher"),
        @Reference(value = "selectedPublicationVenue", key = "venue"),
        @Reference(value = "selectedPublicationTag", key = "tags")
    })
    @FieldSource(
        template = "person/selectedPublications",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @FieldSource(
        template = "person/publicationDates",
        predicate = "http://vivoweb.org/ontology/core#dateTime"
    )
    // duplicate of selectedPublicationDate without encoded reference to publication
    private List<String> publicationDates;

    @FieldType(type = "nested_whole_strings")
    @FieldSource(
        template = "person/selectedPublicationType",
        predicate = "http://vitro.mannlib.cornell.edu/ns/vitro/0.7#mostSpecificType",
        parse = true
    )
    ...
    @FieldSource(
        template = "person/selectedPublicationDate",
        predicate = "http://vivoweb.org/ontology/core#dateTime"
    )
    private List<String> selectedPublicationDate;

    @FieldType(type = "nested_whole_strings", copyTo = { "selectedPublicationPublisher_facets" })
    @FieldSource(
    ...
    @FieldType(type = "nested_whole_strings", copyTo = { "selectedPublicationVenue_facets" })
    @FieldSource(
    ...
    @FieldType(type = "nested_whole_strings", copyTo = { "selectedPublicationTag_facets" })
    @FieldSource(
    ...
    @FieldType(type = "nested_whole_strings")
    @FieldSource(
        template = "person/creativeWorkType",
    ...
    @FieldSource(
        template = "person/collectionOrSeriesEditorFor",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @NestedObject(properties = {
        ...
        @Reference(value = "editorOfPageEnd", key = "pageEnd"),
        @Reference(value = "editorOfDate", key = "date")
    })
    @FieldSource(
        template = "person/editorOf",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @FieldType(type = "tokenized_string")
    @FieldSource(
        template = "person/researchOverview",
        predicate = "http://vivoweb.org/ontology/core#researchOverview"
    )
    ...
    @FieldSource(
        template = "person/researcherOnAwardedBy",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @FieldSource(
        template = "person/otherResearchActivity",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @FieldType(type = "tokenized_string")
    @FieldSource(
        template = "person/teachingOverview",
        predicate = "http://vivoweb.org/ontology/core#teachingOverview"
    )
    ...
    @FieldSource(
        template = "person/teachingActivity",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @FieldType(type = "nested_whole_strings")
    @FieldSource(
        template = "person/teachingMaterials",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @FieldType(type = "tokenized_string")
    @FieldSource(
        template = "person/outreachOverview",
        predicate = "http://vivoweb.org/ontology/core#outreachOverview"
    )
    ...
    @FieldSource(
        template = "person/contactOrProvidorForService",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @FieldSource(
        template = "person/organizerOfEvent",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @FieldSource(
        template = "person/professionalServiceActivity",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @FieldSource(
        template = "person/outreachAndCommunityServiceActivity",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @FieldType(type = "whole_string")
    @FieldSource(
        template = "person/eraCommonsId",
        predicate = "http://vivoweb.org/ontology/core#eRACommonsId"
    )
    private String eraCommonsId;

    @FieldType(type = "whole_string")
    @FieldSource(
        template = "person/isiResearcherId",
        predicate = "http://vivoweb.org/ontology/core#researcherId"
    )
    ...
    @FieldType(type = "whole_string")
    @FieldSource(
        template = "person/healthCareProviderId",
        predicate = "http://purl.obolibrary.org/obo/ARG_0000197"
    )
    ...
    @FieldSource(
        ...
        predicate = "http://www.w3.org/2006/vcard/ns#givenName"
    )
    ...
    @FieldSource(
        ...
        predicate = "http://www.w3.org/2006/vcard/ns#familyName"
    )
    ...
    @FieldType(type = "nested_whole_strings")
    @FieldSource(
        template = "person/futureResearchIdeas",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @NestedObject(properties = {
        @Reference(value = "capstoneAdvisedOfUrl", key = "url"),
        @Reference(value = "capstoneAdvisedOfPublicationDate", key = "publicationDate")
    })
    @FieldType(type = "nested_whole_strings")
    @FieldSource(
        template = "person/capstoneAdvisedOf",
        predicate = "http://www.w3.org/2000/01/rdf-schema#label"
    )
    ...
    @FieldType(type = "nested_whole_strings")
    @FieldSource(
        template = "person/capstoneAdvisedOfUrl",
        predicate = "http://www.w3.org/2006/vcard/ns#url"
    )
    ...
    @FieldType(type = "nested_dates")
    @FieldSource(
        template = "person/capstoneAdvisedOfPublicationDate",
        predicate = "http://vivoweb.org/ontology/core#dateTime"
    )
    ...
    @FieldType(type = "whole_string")
    @FieldSource(
        template = "person/featuredProfileDisplay",
        predicate = "http://vivo.library.tamu.edu/ontology/TAMU#FeaturedProfileDisplay"
    )
    private String featuredProfileDisplay;

    @FieldType(type = "whole_string")
    @FieldSource(
        template = "person/publicationToInterfolio",
    ...
    public void setOutreachAndCommunityServiceActivityEndDate(
        List<String> outreachAndCommunityServiceActivityEndDate
    ) {
